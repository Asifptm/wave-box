...
function buildYtDlpArgs(watchUrl) {
  const args = [
    // No narrow -f filter: some clients only expose limited formats with cookies
    "-o",
    "-",
    "--no-playlist",
    "--no-warnings",
    ...
    "5",
    "--extractor-args",
    // web + cookies is most reliable on cloud hosts; keep mobile as fallbacks
    "youtube:player_client=web,android,ios,android_music",
    "--user-agent",
